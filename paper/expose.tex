...
%\usepackage{caption} \usepackage{float} \usepackage{hyperref}
\usepackage{graphicx} \usepackage[nottoc, numbib]{tocbibind}
%\usepackage{outlines}
...
\item Something the user is (e.g. a fingerprint) \end{itemize} MFA is used to
  ...
  \section{Phishing Attacks: Evolution and Impact} Phishing attacks are a type

...
Creating and maintaining such a large dataset

TODO: ethical concerns, lack of mobile device fingerprints

\paragraph{Need for open-source browser testing framework}
TODO: needs to support many browser versions

\paragraph{Existing counter measures are good and can be improved}

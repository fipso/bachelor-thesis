...
for routing and parsing of incoming requests. After one provides valid login credentials in the frontend, the backend
will respond with a "Set-Cookie" header that creates a cookie containing the session token in the browser.
This session token will be used to authenticate the user in the future.
